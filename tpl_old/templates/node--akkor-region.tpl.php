...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="region-akkor-head"><?php print render($region); ?></div>
  ...
  <?php print render($title_suffix); ?>
      ...
      <tr>
          <td colspan="2">
  <div class="region-akkor-address"><?php print render($address); ?></div>
          </td>
          <td>
              <div class="region-akkor-code"><?php print render($code); ?></div>
              <?php if (!empty($timezone)): ?>
              <div class="timezone"><?php print render($timezone); ?></div>
              <?php endif; ?>
          </td>
      </tr>
      ...
      <?php foreach ($persons as $person): ?>
          <tr>
              <td class="post">
                <?php print render($person['field_text_simple_2']); ?>
              </td>
              <td class="person">
                  <?php if (!empty($person['field_text_simple_3'])): ?>
                  <div class="fio"><?php print render($person['field_text_simple_3']); ?></div>
                  <?php endif; ?>
                  <?php if (!empty($person['field_date_1']['#markup']['#is_empty'])): ?>
                  <div class="born"><?php print date('d.m.Y', strtotime($person['field_date_1']['#markup'])); ?> г.р.</div>
                  <?php endif; ?>
                  <?php if (!empty($person['field_text_full_1'])): ?>
                  <div class="personal-contacts"><?php print render($person['field_text_full_1']); ?></div>
                  <?php endif; ?>
              </td>
              <td class="contacts">
